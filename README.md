...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/sweet-mountain-871f#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-mountain-871f
```

A live public deployment of this template is available at [https://sweet-mountain-871f.templates.workers.dev](https://sweet-mountain-871f.templates.workers.dev)
